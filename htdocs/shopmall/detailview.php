...
$totalmount = mysql_result($result, 0, "totalmount");
...
echo ("
	...
	<table border=0 width=900  style='border:1px solid black; border-collapse:collapse;'>
");
...
echo("
	<tr><td align=center style='border:1px solid black; border-collapse:collapse;'><font size=2>$ordernum</td>
...
$usept=$totalprice-$totalmount;

echo ("
	</td>
	<td align=right style='border:1px solid black; border-collapse:collapse;'><font color=red size=2><b>$totalmount</b></td>
	</tr>
	<tr><td colspan=4><font size=2>사용한 포인트: <b>$usept</b> 포인트</font></td></tr>
	</table>
");
...
echo ("
	<tr><td align=center style='border:1px solid black; border-collapse:collapse;'><font size=2>$sender</td>
	<td align=center style='border:1px solid black; border-collapse:collapse;'><font size=2>$receiver</td>
	<td style='border:1px solid black; border-collapse:collapse;'><font size=2>$address</td>
	<td align=center style='border:1px solid black; border-collapse:collapse;'><font size=2>$phone</td></tr>
